    ...
    return (
        <div id="whyus" className=" bg-bodymain sm:pt-11 mt-[-2px] ">
            <div className="max-w-[1320px] mx-auto px-3">
                ...
                <p className="font-medium text-xxl text-dark-gray mt-[22px] tracking-[0.2px]">Tweak anything and everything to ensure fits<br />your business, not the other way around.</p>
                <div className=" overflow-hidden my-10 md:mb-20 md:mt-[92px]  pt-9 px-3 sm:px-6 lg:px-10 border-[#3C3C3C] border  rounded-[20px] bg-[#0A0A0A] ">
                    ...
                    <img src={clupiAiImage} alt="crmai" height={387} className="max-sm:object-contain  h-full lg:h-96 w-full rounded-t-[20px]" />
                </div>
                ...
                <p className=" pt-7 pb-12 text-dark-gray  font-medium text-sm leading-5 tracking-[-0.1px] text-center">Davio White <br /> Chief of Staff, Pallet</p>
            </div>
        </div>
    );
};
