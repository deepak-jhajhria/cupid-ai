...
export const serviceCardItems = [
    { id: 1, svgIcons: <ServiceSvg />, heading: "Content Deepfakes", paragraph: "Seize control and elevate your business with our hyper-realistic AI description creation. Immerse in a blend of artistry and technology that promises unparalleled authenticity.", width: "sm:w-7/12 sm:max-w-[540px] xl:max-w-[526px]", },
    { id: 2, svgIcons: <ServiceSvg2 />, heading: "AI Verifications", paragraph: "Streamline your workflow with our AI verification system that boasts a stellar 80% first-time success rate.", width: "sm:w-5/12 sm:max-w-[430px] xl:max-w-[416px]", },
    { id: 3, svgIcons: <ServiceSvg3 />, heading: "Content Utilities", paragraph: "Consolidate your resources with our comprehensive   description utilities. Access everything you need from a single dashboard.", width: "sm:w-5/12 sm:max-w-[430px] xl:max-w-[416px]", },
    { id: 4, svgIcons: <ServiceSvg4 />, heading: "Image Generation", paragraph: "Transform productivity with our sophisticated automation tools. Let technology work tirelessly behind the scenes, so your creativity never has to pause.", width: "sm:w-7/12 sm:max-w-[540px] xl:max-w-[526px]", },
]
// pricing data
            ...
            {Includedata.map((line, index) => {
                return (
                    <div key={index} className='flex gap-3 '>
                        <span><WhiteTick /></span>
                        <p className='text-xs font-normal text-white sm:text-2sm leading-2xl'>{line.description}</p>
                    </div>
                )
            })}
        </div>)
...
export const Entrepreneurcontent = () => {
    return (<div className='flex flex-col gap-4'>
        ...
        <div className='flex gap-3'>
            <div><RedStar /></div>
            <p className='text-xs font-normal text-white sm:text-2sm leading-2xl'>More Coming Soon</p>
        </div>
    </div>)
}
