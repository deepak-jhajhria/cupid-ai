        ...
        <div className='relative mt-5 lg:mt-20 sm:mt-20 overflow-x-clip'>
            <div id='pricing' className="xl:max-w-[1219px] lg:pt-24 md:pt-14 container">
                ...
                <div className='bg-gray-white-500 rounded-4xl p-1 max-w-[192px] mx-auto w-full flex justify-between md:mt-[44.5px] mt-6'>
                    <button onClick={() => setToggle(1)} className={`py-[6px] px-[18px] rounded-5xl text-base  transition-all duration-300 ease-linear font-medium text-white ${toggle === 1 ? "bg-gray-white-500" : ""}`}>Yearly</button>
                    <button onClick={() => setToggle(2)} className={`py-[6px] px-[18px] rounded-5xl text-base font-medium text-white transition-all duration-300 ease-linear ${toggle === 2 ? "bg-gray-white-500" : ""}`}>Monthly</button>
                </div>
                    ...
                    {toggle === 2 && <>
                        {
                            PricedataMonth.map((item, index) => (
                                <div key={index} className='flex items-center justify-center w-full mt-8 lg:w-4/12 md:w-6/12 lg:mt-0 md:mt-10'>
                                    <div className='max-w-[410px] relative z-10 transition-all duration-300 cursor-pointer blur_box_border hover:scale-y-[1.09] hover:z-20 group lg:min-h-[723px] md:min-h-[774px] min-h-[667px] h-full'>
                    ...
                    {toggle === 1 && <>
                        {
                            PricedataYear.map((item, index) => (
                                <div key={index} className='flex items-center justify-center w-full mt-8 lg:w-4/12 md:w-6/12 sm:w-10/12 lg:mt-0 md:mt-10'>
                                    <div className='max-w-[410px] relative z-10 transition-all duration-300 ease-linear cursor-pointer blur_box_border hover:scale-y-[1.09] hover:z-20 group lg:min-h-[723px] md:min-h-[774px] min-h-[667px] h-full'>
                ...
                <div className='flex items-center justify-center'>
                    <a href='https:' className='bg-gray-white-500 inline-flex items-center justify-center sm:flex-row flex-col text-white sm:px-4 px-8 py-1.5 sm:rounded-4xl rounded-3xl sm:gap-2 gap-1 mt-12 group'><p className='font-medium text-2sm leading-17 opacity-60 tracking-tightest'>Want enterprise features?</p><p className='flex items-center gap-1 font-bold text-2sm tracking-tightest leading-17'>Tell us more <WhiteArrow /></p></a>
                </div>
            </div>
