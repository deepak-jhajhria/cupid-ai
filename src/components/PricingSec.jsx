...
const PricingSec = () => {
    ...
    return (
        <div className='relative xl:mt-20 overflow-x-clip'>
            <div id='pricing' className="xl:max-w-[1219px] xl:pt-24 md:pt-14 pt-10 container max-w-[1320px]">
                ...
                <div className='flex items-center flex-wrap justify-center w-full lg:mt-12 xl:mt-16 sm:mt-10 mt-6 min-h-[780px]'>
                    {toggle === 2 && <>
                        {
