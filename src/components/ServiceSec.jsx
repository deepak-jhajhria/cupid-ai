...
const ServiceSec = () => {
    return (
        <div id='service' className="bg-[url(./assets/images/servicebg.webp)] bg-BgSizeFull bg-center bg-no-repeat">
            <div className='py-10  sm:py-12 md:py-16 lg:py-[101px] bg-bg_gradient'>
                <div className='max-w-[980px] px-3 lg:px-0 mx-auto '>
                    ...
                    <p className=' font-medium text-gray sm:text-xxl text-xl  text-center mx-auto leading-16 max-w-[480px] md:pt-3 pt-2 lg:pt-5'>Tweak anything and everything to ensure fits your business, not the other way around.</p>
